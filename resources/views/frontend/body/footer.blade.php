                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div class="module-body">
                        <ul class='list-unstyled'>
                            ...
                            <li><a title="Addresses" href=" https://wa.me/62895335872261">Kontak Kami</a></li>
                        </ul>
                    </div>
                    <!-- /.module-body -->
                </div>
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-12 no-padding social">
                <p class="text-center" style="color: #b667f1"><i class="fa fa-copyright" aria-hidden="true"></i>2024 Queen of Thrift. All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>